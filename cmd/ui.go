...
func ShowMenuOptionsCLI() {
	...
	fmt.Print(Banner)
	fmt.Println("---------------------------------")
	fmt.Println("---    GymRat CLI Options     ---")
	fmt.Println("---------------------------------")
	fmt.Println("1: View Exercise Catalog")
	fmt.Println("2: Add New Exercise to Catalog")
	fmt.Println("3: Update Exercise (New Version)")
	fmt.Println("4: Soft Delete Exercise (Toggle IsRemoved)")
	fmt.Println("5: View All Workout Plans")
	fmt.Println("6: Search for a Workout Plan")
	fmt.Println("7: Create New Workout Plan")
	fmt.Println("8: Mark Workout Executed")
	fmt.Println("9: Exit")
	fmt.Println("---------------------------------")
}
